 ...
 */
package com.microservices.demo.kafka.model.avro;
...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1502125550940761028L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TwitterAvroModel\",\"namespace\":\"com.microservices.demo.kafka.model.avro\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"string\",\"null\"]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder newBuilder() {
    return new com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder();
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder newBuilder(com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder other) {
    if (other == null) {
      return new com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder newBuilder(com.microservices.demo.kafka.model.avro.TwitterAvroModel other) {
    if (other == null) {
      return new com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.microservices.demo.kafka.model.avro.TwitterAvroModel other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder setText(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.kafka.model.avro.TwitterAvroModel.Builder clearCreatedAt() {
      createdAt = null;
